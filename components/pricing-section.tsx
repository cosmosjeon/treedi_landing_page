          ...
          <div className="flex-1 max-w-[1060px] w-full px-6 md:px-10 py-8 md:py-12 border border-[#E0DEDB] overflow-hidden rounded-lg flex flex-col justify-start items-start gap-10 bg-white">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-8">
                <div className="self-stretch flex flex-col justify-start items-start gap-2">
                  <div className="text-[rgba(55,50,47,0.90)] text-xl md:text-2xl font-semibold leading-7 font-sans">Pricing</div>
                </div>
                ...
                <div className="self-stretch flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10">
                  ...
                  <div className="flex flex-col items-start gap-3 min-w-[200px]">
                    <div className="text-[#37322F] text-6xl md:text-7xl font-semibold leading-none font-serif">0₩</div>
                    <div className="text-[#847971] text-sm md:text-base font-medium font-sans">Beta 기간</div>
                    <div className="px-6 py-[12px] bg-[#37322F] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] rounded-[99px] flex justify-center items-center">
                      <div className="text-[#FBFAF9] text-[14px] md:text-[15px] font-medium leading-5 font-sans">무료로 시작하기</div>
                    </div>
                  </div>
                </div>
              </div>
