        ...
        <div className="h-6 sm:h-7 md:h-8 flex items-center gap-2 sm:gap-3">
          ...
          >
            <button
              ...
              className="flex items-center justify-center h-8 w-8 bg-white text-[#37322F] rounded-full shadow-[0px_1px_2px_rgba(55,50,47,0.12)] hover:bg-[#f0eeeb] transition"
              aria-haspopup="menu"
            ...
            {isLanguageMenuOpen ? (
              <div
                className="absolute right-0 mt-1 w-36 rounded-lg border border-[rgba(55,50,47,0.12)] bg-white py-1 shadow-[0px_8px_16px_rgba(55,50,47,0.12)] z-50"
                onMouseEnter={() => {
                  if (hoverCloseTimerRef.current) {
                    window.clearTimeout(hoverCloseTimerRef.current)
                    hoverCloseTimerRef.current = null
